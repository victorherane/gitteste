  ...
  return (
    <div className="h-full p-4 pb-8 w-full">
      <div className="w-full">
        <h1 className="w-full text-center text-[30px] font-bold mb-16">
          Github Tecnorise teste
        </h1>
        ...
        {states.repositoriesLoading || states.repositoryByNameLoading ? (
          ...
          <>
            <RepositoriesTable
              repositories={states.repositories}
              onClickRepository={handlers.handleClickRepository}
            />
